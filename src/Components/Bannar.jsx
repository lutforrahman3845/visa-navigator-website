...
const Bannar = () => {
  return (
    <div className="relative  dark:bg-secondary px-6 pt-2 mb-10 ">
      <Swiper
        ...
        className="w-[98%] md:w-full h-[250px] md:h-[500px] lg:h-[600px] rounded-sm"
      >
        <SwiperSlide className=" relative bg-primary ">
          <div className="absolute top-1/2 left-2 md:left-20 -translate-y-1/2 z-50 text-white">
            <h1 className="text-xl md:text-3xl lg:text-5xl  font-bold max-w-2xl ">
            Journey with Confidence Migrate with Us
            </h1>
            <p className="text-sm sm:text-base  max-w-2xl text-gray-200 my-2 font-light">
            ...
            <button className="py-2 px-3 rounded-md bg-[#054833] text-white mt-8">
              Get start
            </button>
          </div>
          <img
        ...
        <SwiperSlide className=" relative text-black">
          <div className="absolute top-1/2 left-2 md:left-20 -translate-y-1/2 z-50  text-white">
            ...
            <p className="text-sm sm:text-base max-w-2xl my-2 text-gray-200 font-light">
            ...
            <button className="py-2 px-3 rounded-md bg-primary text-white mt-8">
              Get start
            </button>
          </div>
          <img
        ...
        <SwiperSlide className="relative">
          ...
          <div className="absolute top-1/2 left-2 md:left-20 -translate-y-1/2 z-20">
            <h1 className="text-xl md:text-3xl lg:text-5xl font-bold max-w-2xl text-white">
              Simplifying Your Visa Journey with Expertise and Care
            </h1>
            <p className="text-sm sm:text-base text-gray-200 max-w-2xl my-2 font-light">
          ...
          <img
            src={bnnr1}
            alt="Banner image"
            className="w-full h-11/12 object-cover rounded-sm z-0"
          />
        </SwiperSlide>
      </Swiper>
    </div>
